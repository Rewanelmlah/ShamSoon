    ...
    return Padding(
        ...
        child: BlocBuilder<HomeCubit, HomeState>(
            builder: (context, state) => StatusBuilder(
                ...
                placeHolder: '  ',
                builder: (placeHolder, isLoading) => isLoading? CustomLoading.showLoadingView() : SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          CustomResponsiveContainer(text: state.carbon!.co2Saved.toString(), icon: Icons.wb_incandescent_outlined, number: '9k/h')
                        ],),
                      SizedBox(height: 15.h,),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: [
                          ...
                          CustomResponsiveContainer(text: state.carbon!.equivalentTrees.toString(), icon: Icons.forest_outlined, number: '7')
                        ],),
                      SizedBox(height: 10.h,),
